 ...
 *  docsributed under the License is docsributed on an "AS IS" BASIS,
...
// Lint JavaScript
gulp.task('lint', () =>
  gulp.src(['app/scripts/**/*.js', '!node_modules/**', '!app/scripts/vender/*.js'])
    .pipe($.eslint())
    .pipe($.eslint.format())
...
// Build and serve the output from the docs build
